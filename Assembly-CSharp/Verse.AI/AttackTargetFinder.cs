...
namespace Verse.AI
{
	public static class AttackTargetFinder
	{
		...
		public static IAttackTarget BestAttackTarget(IAttackTargetSearcher searcher, TargetScanFlags flags, Predicate<Thing> validator = null, float minDist = 0f, float maxDist = 9999f, IntVec3 locus = default(IntVec3), float maxTravelRadiusFromLocus = 3.40282347E+38f, bool canBash = false)
		{
			...
			IntVec3 arg_3BF_0 = searcherThing.Position;
			Map arg_3BF_1 = searcherThing.Map;
			ThingRequest arg_3BF_2 = ThingRequest.ForGroup(ThingRequestGroup.AttackTarget);
			PathEndMode arg_3BF_3 = PathEndMode.Touch;
			bool canBash2 = canBash;
			IAttackTarget attackTarget = (IAttackTarget)GenClosest.ClosestThingReachable(arg_3BF_0, arg_3BF_1, arg_3BF_2, arg_3BF_3, TraverseParms.For(searcherPawn, Danger.Deadly, TraverseMode.ByPawn, canBash2), maxDist, (Thing x) => innerValidator((IAttackTarget)x), null, searchRegionsMax, false, RegionType.Set_Passable);
