...
namespace Verse.AI
{
	public class JobDriver_DoBill : JobDriver
	{
		...
		{
			JobDriver_DoBill.<MakeNewToils>c__Iterator1B9 <MakeNewToils>c__Iterator1B = new JobDriver_DoBill.<MakeNewToils>c__Iterator1B9();
			<MakeNewToils>c__Iterator1B.<>f__this = this;
			JobDriver_DoBill.<MakeNewToils>c__Iterator1B9 expr_0E = <MakeNewToils>c__Iterator1B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
