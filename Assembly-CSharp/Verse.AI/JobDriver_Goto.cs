...
namespace Verse.AI
{
	public class JobDriver_Goto : JobDriver
	{
		...
		{
			JobDriver_Goto.<MakeNewToils>c__Iterator1B0 <MakeNewToils>c__Iterator1B = new JobDriver_Goto.<MakeNewToils>c__Iterator1B0();
			<MakeNewToils>c__Iterator1B.<>f__this = this;
			JobDriver_Goto.<MakeNewToils>c__Iterator1B0 expr_0E = <MakeNewToils>c__Iterator1B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
