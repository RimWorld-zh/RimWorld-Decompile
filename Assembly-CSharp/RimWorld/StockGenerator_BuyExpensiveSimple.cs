...
namespace RimWorld
{
	public class StockGenerator_BuyExpensiveSimple : StockGenerator
	{
		...
		{
			StockGenerator_BuyExpensiveSimple.<GenerateThings>c__Iterator176 <GenerateThings>c__Iterator = new StockGenerator_BuyExpensiveSimple.<GenerateThings>c__Iterator176();
			StockGenerator_BuyExpensiveSimple.<GenerateThings>c__Iterator176 expr_07 = <GenerateThings>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
