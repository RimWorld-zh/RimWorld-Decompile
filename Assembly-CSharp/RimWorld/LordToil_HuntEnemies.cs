...
namespace RimWorld
{
	public class LordToil_HuntEnemies : LordToil
	{
		private LordToilData_HuntEnemies Data
		{
			get
			{
				return (LordToilData_HuntEnemies)base.data;
			}
		}

		public LordToil_HuntEnemies(IntVec3 fallbackLocation)
		{
			base.data = new LordToilData_HuntEnemies();
		...
		public override void UpdateAllDuties()
		{
			...
			for (int i = 0; i < base.lord.ownedPawns.Count; i++)
			{
				...
				{
					RCellFinder.TryFindRandomSpotJustOutsideColony(base.lord.ownedPawns[0], out data.fallbackLocation);
				}
