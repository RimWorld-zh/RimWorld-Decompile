...
namespace RimWorld
{
	public static class Autotests_RandomNumbers
	{
		...
		{
			Autotests_RandomNumbers.<RandomFloats>c__Iterator1A4 <RandomFloats>c__Iterator1A = new Autotests_RandomNumbers.<RandomFloats>c__Iterator1A4();
			<RandomFloats>c__Iterator1A.count = count;
			<RandomFloats>c__Iterator1A.<$>count = count;
			Autotests_RandomNumbers.<RandomFloats>c__Iterator1A4 expr_15 = <RandomFloats>c__Iterator1A;
			expr_15.$PC = -2;
			return expr_15;
		}
