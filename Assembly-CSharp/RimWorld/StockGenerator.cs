...
namespace RimWorld
{
	public abstract class StockGenerator
	{
		...
		{
			StockGenerator.<ConfigErrors>c__Iterator171 <ConfigErrors>c__Iterator = new StockGenerator.<ConfigErrors>c__Iterator171();
			StockGenerator.<ConfigErrors>c__Iterator171 expr_07 = <ConfigErrors>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
