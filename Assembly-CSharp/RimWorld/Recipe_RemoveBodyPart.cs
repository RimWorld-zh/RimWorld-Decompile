...
namespace RimWorld
{
	internal class Recipe_RemoveBodyPart : Recipe_Surgery
	{
		...
		{
			Recipe_RemoveBodyPart.<GetPartsToApplyOn>c__IteratorC3 <GetPartsToApplyOn>c__IteratorC = new Recipe_RemoveBodyPart.<GetPartsToApplyOn>c__IteratorC3();
			<GetPartsToApplyOn>c__IteratorC.pawn = pawn;
			<GetPartsToApplyOn>c__IteratorC.<$>pawn = pawn;
			Recipe_RemoveBodyPart.<GetPartsToApplyOn>c__IteratorC3 expr_15 = <GetPartsToApplyOn>c__IteratorC;
			expr_15.$PC = -2;
			return expr_15;
		}
