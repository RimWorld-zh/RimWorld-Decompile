...
namespace RimWorld
{
	public class CompSpawner : ThingComp
	{
		...
		{
			CompSpawner.<CompGetGizmosExtra>c__Iterator169 <CompGetGizmosExtra>c__Iterator = new CompSpawner.<CompGetGizmosExtra>c__Iterator169();
			<CompGetGizmosExtra>c__Iterator.<>f__this = this;
			CompSpawner.<CompGetGizmosExtra>c__Iterator169 expr_0E = <CompGetGizmosExtra>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
