...
namespace RimWorld
{
	public class CompSpawner : ThingComp
	{
		...
		{
			CompSpawner.<CompGetGizmosExtra>c__Iterator16A <CompGetGizmosExtra>c__Iterator16A = new CompSpawner.<CompGetGizmosExtra>c__Iterator16A();
			<CompGetGizmosExtra>c__Iterator16A.<>f__this = this;
			CompSpawner.<CompGetGizmosExtra>c__Iterator16A expr_0E = <CompGetGizmosExtra>c__Iterator16A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
