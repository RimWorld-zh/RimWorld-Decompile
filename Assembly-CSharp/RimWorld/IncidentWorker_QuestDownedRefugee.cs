...
namespace RimWorld
{
	public class IncidentWorker_QuestDownedRefugee : IncidentWorker
	{
		...
		protected override bool CanFireNowSub(IIncidentTarget target)
		{
			...
			int num = default(int);
			return base.CanFireNowSub(target) && this.TryFindTile(out num) && SiteMakerHelper.TryFindRandomFactionFor(SiteCoreDefOf.DownedRefugee, (IEnumerable<SitePartDef>)null, out faction, true, (Predicate<Faction>)null);
		}
		...
		protected override bool TryExecuteWorker(IncidentParms parms)
		{
			...
			else
			{
				...
				else
				{
					...
					Find.LetterStack.ReceiveLetter(base.def.letterLabel, text, base.def.letterDef, (WorldObject)site, (string)null);
					result = true;
				}
			}
			return result;
