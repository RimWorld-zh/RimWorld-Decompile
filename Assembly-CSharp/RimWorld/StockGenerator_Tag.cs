...
namespace RimWorld
{
	public class StockGenerator_Tag : StockGenerator
	{
		...
		{
			StockGenerator_Tag.<GenerateThings>c__Iterator17A <GenerateThings>c__Iterator17A = new StockGenerator_Tag.<GenerateThings>c__Iterator17A();
			<GenerateThings>c__Iterator17A.<>f__this = this;
			StockGenerator_Tag.<GenerateThings>c__Iterator17A expr_0E = <GenerateThings>c__Iterator17A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
