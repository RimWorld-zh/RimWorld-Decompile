...
namespace RimWorld
{
	public class WorkGiverDef : Def
	{
		...
		{
			WorkGiverDef.<ConfigErrors>c__Iterator1E2 <ConfigErrors>c__Iterator1E = new WorkGiverDef.<ConfigErrors>c__Iterator1E2();
			<ConfigErrors>c__Iterator1E.<>f__this = this;
			WorkGiverDef.<ConfigErrors>c__Iterator1E2 expr_0E = <ConfigErrors>c__Iterator1E;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
