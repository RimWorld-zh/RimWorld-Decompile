...
namespace RimWorld
{
	public static class ScenarioMaker
	{
		...
		{
			ScenarioMaker.<RandomScenPartsOfCategory>c__Iterator127 <RandomScenPartsOfCategory>c__Iterator = new ScenarioMaker.<RandomScenPartsOfCategory>c__Iterator127();
			...
			<RandomScenPartsOfCategory>c__Iterator.<$>scen = scen;
			<RandomScenPartsOfCategory>c__Iterator.<$>cat = cat;
			ScenarioMaker.<RandomScenPartsOfCategory>c__Iterator127 expr_31 = <RandomScenPartsOfCategory>c__Iterator;
			expr_31.$PC = -2;
			return expr_31;
		}
