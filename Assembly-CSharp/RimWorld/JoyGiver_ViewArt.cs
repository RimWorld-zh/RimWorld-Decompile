	...
	public class JoyGiver_ViewArt : JoyGiver
	{
		...
		public override Job TryGiveJob(Pawn pawn)
		{
			...
			try
			{
				...
				{
					if (thing.Faction != Faction.OfPlayer || thing.IsForbidden(pawn) || (!allowedOutside && !thing.Position.Roofed(thing.Map)) || !pawn.CanReserveAndReach(thing, PathEndMode.Touch, Danger.None, 1, -1, ReservationLayer.Default, false))
					{
						return false;
					}
