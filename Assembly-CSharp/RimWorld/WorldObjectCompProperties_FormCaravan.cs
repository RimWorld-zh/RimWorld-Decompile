...
namespace RimWorld
{
	public class WorldObjectCompProperties_FormCaravan : WorldObjectCompProperties
	{
		...
		private sealed class <ConfigErrors>c__Iterator0 : IEnumerable, IEnumerable<string>, IEnumerator, IDisposable, IEnumerator<string>
		{
			...
			internal WorldObjectCompProperties_FormCaravan $this;
			...
			public bool MoveNext()
			{
				...
				this.$current = parentDef.defName + " has WorldObjectCompProperties_FormCaravan but it's not MapParent.";
				if (!this.$disposing)
				{
					this.$PC = 2;
				}
			...
			IEnumerator<string> IEnumerable<string>.GetEnumerator()
			{
				...
				WorldObjectCompProperties_FormCaravan.<ConfigErrors>c__Iterator0 <ConfigErrors>c__Iterator = new WorldObjectCompProperties_FormCaravan.<ConfigErrors>c__Iterator0();
