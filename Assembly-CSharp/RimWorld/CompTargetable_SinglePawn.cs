...
namespace RimWorld
{
	...
	{
		public CompTargetable_SinglePawn()
		{
		}
		...
		private sealed class <GetTargets>c__Iterator0 : IEnumerable, IEnumerable<Thing>, IEnumerator, IDisposable, IEnumerator<Thing>
		{
			...
			IEnumerator<Thing> IEnumerable<Thing>.GetEnumerator()
			{
				...
				CompTargetable_SinglePawn.<GetTargets>c__Iterator0 <GetTargets>c__Iterator = new CompTargetable_SinglePawn.<GetTargets>c__Iterator0();
