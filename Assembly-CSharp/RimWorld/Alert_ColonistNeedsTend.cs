...
namespace RimWorld
{
	public class Alert_ColonistNeedsTend : Alert
	{
		private IEnumerable<Pawn> NeedingColonists
		{
			get
			{
				Alert_ColonistNeedsTend.<>c__Iterator187 <>c__Iterator = new Alert_ColonistNeedsTend.<>c__Iterator187();
				Alert_ColonistNeedsTend.<>c__Iterator187 expr_07 = <>c__Iterator;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
