...
namespace RimWorld
{
	public class Alert_ColonistNeedsRescuing : Alert_Critical
	{
		private IEnumerable<Pawn> ColonistsNeedingRescue
		{
			get
			{
				Alert_ColonistNeedsRescuing.<>c__Iterator183 <>c__Iterator = new Alert_ColonistNeedsRescuing.<>c__Iterator183();
				Alert_ColonistNeedsRescuing.<>c__Iterator183 expr_07 = <>c__Iterator;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
