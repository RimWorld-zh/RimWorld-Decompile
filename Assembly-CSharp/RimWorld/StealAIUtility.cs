...
namespace RimWorld
{
	public static class StealAIUtility
	{
		...
		public static bool TryFindBestItemToSteal(IntVec3 root, Map map, float maxDist, out Thing item, Pawn thief, List<Thing> disallowed = null)
		{
			...
			Predicate<Thing> validator = (Thing t) => (thief == null || thief.CanReserve(t, 1, -1, ReservationLayer.Default, false)) && (disallowed == null || !disallowed.Contains(t)) && t.def.stealable && !t.IsBurning();
