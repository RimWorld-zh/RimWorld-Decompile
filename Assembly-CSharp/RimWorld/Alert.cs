...
namespace RimWorld
{
	...
	public abstract class Alert
	{
		...
		{
			Alert.<DrawInfoPane>c__AnonStorey3E3 <DrawInfoPane>c__AnonStorey3E = new Alert.<DrawInfoPane>c__AnonStorey3E3();
			Text.Font = GameFont.Small;
			Text.Anchor = TextAnchor.UpperLeft;
			...
			{
				Alert.<DrawInfoPane>c__AnonStorey3E3 expr_E2_cp_0 = <DrawInfoPane>c__AnonStorey3E;
