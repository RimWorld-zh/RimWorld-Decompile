...
namespace RimWorld
{
	public static class ThingSelectionUtility
	{
		...
		{
			ThingSelectionUtility.<MultiSelectableThingsInScreenRectDistinct>c__Iterator1A0 <MultiSelectableThingsInScreenRectDistinct>c__Iterator1A = new ThingSelectionUtility.<MultiSelectableThingsInScreenRectDistinct>c__Iterator1A0();
			<MultiSelectableThingsInScreenRectDistinct>c__Iterator1A.rect = rect;
			<MultiSelectableThingsInScreenRectDistinct>c__Iterator1A.<$>rect = rect;
			ThingSelectionUtility.<MultiSelectableThingsInScreenRectDistinct>c__Iterator1A0 expr_15 = <MultiSelectableThingsInScreenRectDistinct>c__Iterator1A;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		{
			ThingSelectionUtility.<MultiSelectableZonesInScreenRectDistinct>c__Iterator1A1 <MultiSelectableZonesInScreenRectDistinct>c__Iterator1A = new ThingSelectionUtility.<MultiSelectableZonesInScreenRectDistinct>c__Iterator1A1();
			<MultiSelectableZonesInScreenRectDistinct>c__Iterator1A.rect = rect;
			<MultiSelectableZonesInScreenRectDistinct>c__Iterator1A.<$>rect = rect;
			ThingSelectionUtility.<MultiSelectableZonesInScreenRectDistinct>c__Iterator1A1 expr_15 = <MultiSelectableZonesInScreenRectDistinct>c__Iterator1A;
			expr_15.$PC = -2;
			return expr_15;
		}
