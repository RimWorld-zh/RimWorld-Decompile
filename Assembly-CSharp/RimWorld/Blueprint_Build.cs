...
namespace RimWorld
{
	public class Blueprint_Build : Blueprint
	{
		...
		{
			Blueprint_Build.<GetGizmos>c__Iterator141 <GetGizmos>c__Iterator = new Blueprint_Build.<GetGizmos>c__Iterator141();
			<GetGizmos>c__Iterator.<>f__this = this;
			Blueprint_Build.<GetGizmos>c__Iterator141 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
