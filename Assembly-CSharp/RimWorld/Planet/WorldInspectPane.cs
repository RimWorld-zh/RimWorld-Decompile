...
namespace RimWorld.Planet
{
	public class WorldInspectPane : Window, IInspectPane
	{
		...
		[CompilerGenerated]
		private static Func<Tile.RoadLink, RoadDef> <>f__am$cache0;

		[CompilerGenerated]
		private static Func<RoadDef, int> <>f__am$cache1;
		...
		[CompilerGenerated]
		private static int <get_TileInspectString>m__1(RoadDef road)
		{
			return road.priority;
		}
	}
}
