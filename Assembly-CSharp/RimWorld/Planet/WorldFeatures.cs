...
namespace RimWorld.Planet
{
	public class WorldFeatures : IExposable
	{
		...
		static WorldFeatures()
		{
		}

		[CompilerGenerated]
		private sealed class <ExposeData>c__AnonStorey0
		{
			internal WorldGrid grid;

			internal WorldFeatures $this;

			public <ExposeData>c__AnonStorey0()
			{
			}

			internal void <>m__0(int i, ushort data)
			{
				this.grid[i].feature = ((data != ushort.MaxValue) ? this.$this.GetFeatureWithID((int)data) : null);
			}
		}
	}
}
