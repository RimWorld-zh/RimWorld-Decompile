...
namespace RimWorld.Planet
{
	public class Caravan_BedsTracker : IExposable
	{
		...
		[CompilerGenerated]
		private static Func<Building_Bed, float> <>f__am$cache0;

		[CompilerGenerated]
		private static Func<Building_Bed, float> <>f__am$cache1;
		...
		static Caravan_BedsTracker()
		{
		}

		[CompilerGenerated]
		private static float <RecalculateUsedBeds>m__0(Building_Bed x)
		{
			return x.GetStatValue(StatDefOf.BedRestEffectiveness, true);
		}

		[CompilerGenerated]
		private static float <RecalculateUsedBeds>m__1(Building_Bed x)
		{
			return x.GetStatValue(StatDefOf.ImmunityGainSpeedFactor, true);
		}
	}
}
