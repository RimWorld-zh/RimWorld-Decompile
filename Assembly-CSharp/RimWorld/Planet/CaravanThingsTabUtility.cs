...
namespace RimWorld.Planet
{
	...
	public static class CaravanThingsTabUtility
	{
		...
		static CaravanThingsTabUtility()
		{
		}

		[CompilerGenerated]
		private sealed class <DoAbandonButton>c__AnonStorey0
		{
			internal Thing t;

			public <DoAbandonButton>c__AnonStorey0()
			{
			}
		...
		[CompilerGenerated]
		private sealed class <DoAbandonButton>c__AnonStorey1
		{
			internal TransferableImmutable t;

			public <DoAbandonButton>c__AnonStorey1()
			{
			}
		...
		[CompilerGenerated]
		private sealed class <DoAbandonSpecificCountButton>c__AnonStorey2
		{
			internal Thing t;

			public <DoAbandonSpecificCountButton>c__AnonStorey2()
			{
			}

			internal string <>m__0()
			{
				return CaravanAbandonOrBanishUtility.GetAbandonOrBanishButtonTooltip(this.t, true);
			}
		}

		[CompilerGenerated]
		private sealed class <DoAbandonSpecificCountButton>c__AnonStorey3
		{
			internal TransferableImmutable t;

			public <DoAbandonSpecificCountButton>c__AnonStorey3()
			{
			}
