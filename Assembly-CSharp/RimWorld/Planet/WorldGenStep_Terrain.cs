...
namespace RimWorld.Planet
{
	public class WorldGenStep_Terrain : WorldGenStep
	{
		...
		[CompilerGenerated]
		private static Func<double, double> <>f__am$cache0;

		public WorldGenStep_Terrain()
		{
		}
		...
		static WorldGenStep_Terrain()
		{
		}

		[CompilerGenerated]
		private static double <SetupRainfallNoise>m__0(double val)
		{
			if (val < 0.0)
			{
				val = 0.0;
