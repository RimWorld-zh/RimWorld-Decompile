...
namespace RimWorld
{
	public class IngestionOutcomeDoer_GiveHediff : IngestionOutcomeDoer
	{
		...
		{
			IngestionOutcomeDoer_GiveHediff.<SpecialDisplayStats>c__Iterator80 <SpecialDisplayStats>c__Iterator = new IngestionOutcomeDoer_GiveHediff.<SpecialDisplayStats>c__Iterator80();
			<SpecialDisplayStats>c__Iterator.parentDef = parentDef;
			<SpecialDisplayStats>c__Iterator.<$>parentDef = parentDef;
			<SpecialDisplayStats>c__Iterator.<>f__this = this;
			IngestionOutcomeDoer_GiveHediff.<SpecialDisplayStats>c__Iterator80 expr_1C = <SpecialDisplayStats>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
