...
namespace RimWorld
{
	public class Blueprint_Install : Blueprint
	{
		...
		{
			Blueprint_Install.<GetGizmos>c__Iterator142 <GetGizmos>c__Iterator = new Blueprint_Install.<GetGizmos>c__Iterator142();
			<GetGizmos>c__Iterator.<>f__this = this;
			Blueprint_Install.<GetGizmos>c__Iterator142 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
