...
namespace RimWorld
{
	...
	public class CompAffectedByFacilities : ThingComp
	{
		...
		private IEnumerable<Thing> ThingsICanLinkTo
		{
			get
			{
				CompAffectedByFacilities.<>c__Iterator160 <>c__Iterator = new CompAffectedByFacilities.<>c__Iterator160();
				<>c__Iterator.<>f__this = this;
				CompAffectedByFacilities.<>c__Iterator160 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			CompAffectedByFacilities.<PotentialThingsToLinkTo>c__Iterator161 <PotentialThingsToLinkTo>c__Iterator = new CompAffectedByFacilities.<PotentialThingsToLinkTo>c__Iterator161();
			...
			<PotentialThingsToLinkTo>c__Iterator.<$>myPos = myPos;
			<PotentialThingsToLinkTo>c__Iterator.<$>myRot = myRot;
			CompAffectedByFacilities.<PotentialThingsToLinkTo>c__Iterator161 expr_3F = <PotentialThingsToLinkTo>c__Iterator;
			expr_3F.$PC = -2;
			return expr_3F;
		}
