...
namespace RimWorld
{
	public class TaleData_Trader : TaleData
	{
		...
		{
			TaleData_Trader.<GetRules>c__Iterator12D <GetRules>c__Iterator12D = new TaleData_Trader.<GetRules>c__Iterator12D();
			<GetRules>c__Iterator12D.prefix = prefix;
			<GetRules>c__Iterator12D.<$>prefix = prefix;
			<GetRules>c__Iterator12D.<>f__this = this;
			TaleData_Trader.<GetRules>c__Iterator12D expr_1C = <GetRules>c__Iterator12D;
			expr_1C.$PC = -2;
			return expr_1C;
		}
