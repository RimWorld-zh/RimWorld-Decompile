...
namespace RimWorld
{
	public static class CollectionsMassCalculator
	{
		...
		[CompilerGenerated]
		private static Action<Thing, int> <>f__am$cache2;

		[CompilerGenerated]
		private static Action<Thing, int> <>f__am$cache3;
		...
		static CollectionsMassCalculator()
		{
		}

		[CompilerGenerated]
		private static void <CapacityTransferables>m__0(Thing originalThing, int toTake)
		{
			CollectionsMassCalculator.tmpThingCounts.Add(new ThingCount(originalThing, toTake));
		}

		[CompilerGenerated]
		private static void <CapacityLeftAfterTransfer>m__1(Thing originalThing, int toTake)
		{
			CollectionsMassCalculator.tmpThingCounts.Add(new ThingCount(originalThing, toTake));
		}

		[CompilerGenerated]
		private static void <MassUsageTransferables>m__2(Thing originalThing, int toTake)
		{
			CollectionsMassCalculator.tmpThingCounts.Add(new ThingCount(originalThing, toTake));
		}

		[CompilerGenerated]
		private static void <MassUsageLeftAfterTransfer>m__3(Thing originalThing, int toTake)
		{
			CollectionsMassCalculator.tmpThingCounts.Add(new ThingCount(originalThing, toTake));
		}
	}
