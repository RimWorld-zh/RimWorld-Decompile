...
namespace RimWorld
{
	public class CompForbiddable : ThingComp
	{
		...
		{
			CompForbiddable.<CompGetGizmosExtra>c__Iterator162 <CompGetGizmosExtra>c__Iterator = new CompForbiddable.<CompGetGizmosExtra>c__Iterator162();
			<CompGetGizmosExtra>c__Iterator.<>f__this = this;
			CompForbiddable.<CompGetGizmosExtra>c__Iterator162 expr_0E = <CompGetGizmosExtra>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
