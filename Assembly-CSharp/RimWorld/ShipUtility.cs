...
namespace RimWorld
{
	public static class ShipUtility
	{
		...
		{
			ShipUtility.<LaunchFailReasons>c__Iterator16E <LaunchFailReasons>c__Iterator16E = new ShipUtility.<LaunchFailReasons>c__Iterator16E();
			<LaunchFailReasons>c__Iterator16E.rootBuilding = rootBuilding;
			<LaunchFailReasons>c__Iterator16E.<$>rootBuilding = rootBuilding;
			ShipUtility.<LaunchFailReasons>c__Iterator16E expr_15 = <LaunchFailReasons>c__Iterator16E;
			expr_15.$PC = -2;
			return expr_15;
		}
