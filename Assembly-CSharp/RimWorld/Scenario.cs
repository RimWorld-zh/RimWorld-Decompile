...
namespace RimWorld
{
	public class Scenario : IExposable, WorkshopUploadable
	{
		...
		public IEnumerable<ScenPart> AllParts
		{
			get
			{
				Scenario.<>c__Iterator123 <>c__Iterator = new Scenario.<>c__Iterator123();
				<>c__Iterator.<>f__this = this;
				Scenario.<>c__Iterator123 expr_0E = <>c__Iterator;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
		...
		{
			Scenario.<ConfigErrors>c__Iterator124 <ConfigErrors>c__Iterator = new Scenario.<ConfigErrors>c__Iterator124();
			<ConfigErrors>c__Iterator.<>f__this = this;
			Scenario.<ConfigErrors>c__Iterator124 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
