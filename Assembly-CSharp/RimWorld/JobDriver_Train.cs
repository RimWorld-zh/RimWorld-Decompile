	...
	public class JobDriver_Train : JobDriver_InteractAnimal
	{
		...
		private sealed class <MakeNewToils>c__Iterator0 : IEnumerable, IEnumerable<Toil>, IEnumerator, IDisposable, IEnumerator<Toil>
		{
			...
			IEnumerator<Toil> IEnumerable<Toil>.GetEnumerator()
			{
				...
				JobDriver_Train.<MakeNewToils>c__Iterator0 <MakeNewToils>c__Iterator = new JobDriver_Train.<MakeNewToils>c__Iterator0();
			...
			internal bool <>m__0()
			{
				return base.Animal.training.NextTrainableToTrain() == null && !base.OnLastToil;
			}
		}
	}
}
