...
namespace RimWorld
{
	public class StatPart_Age : StatPart
	{
		...
		{
			StatPart_Age.<ConfigErrors>c__Iterator1A9 <ConfigErrors>c__Iterator1A = new StatPart_Age.<ConfigErrors>c__Iterator1A9();
			<ConfigErrors>c__Iterator1A.<>f__this = this;
			StatPart_Age.<ConfigErrors>c__Iterator1A9 expr_0E = <ConfigErrors>c__Iterator1A;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
