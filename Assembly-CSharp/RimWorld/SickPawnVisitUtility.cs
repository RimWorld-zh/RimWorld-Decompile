...
namespace RimWorld
{
	public static class SickPawnVisitUtility
	{
		...
		public static Thing FindChair(Pawn forPawn, Pawn nearPawn)
		{
			...
			return GenClosest.ClosestThingReachable(nearPawn.Position, nearPawn.Map, ThingRequest.ForGroup(ThingRequestGroup.BuildingArtificial), PathEndMode.OnCell, TraverseParms.For(forPawn, Danger.Deadly, TraverseMode.ByPawn, false), 2.2f, validator, null, 5, false, RegionType.Set_Passable);
		}
