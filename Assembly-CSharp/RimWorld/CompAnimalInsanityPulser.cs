...
namespace RimWorld
{
	public class CompAnimalInsanityPulser : ThingComp
	{
		...
		public CompAnimalInsanityPulser()
		{
		}
		...
		[CompilerGenerated]
		private bool <DoAnimalInsanityPulse>m__0(Pawn p)
		{
			return p.RaceProps.Animal && p.Position.InHorDistOf(this.parent.Position, (float)this.Props.radius);
		}
	}
}
