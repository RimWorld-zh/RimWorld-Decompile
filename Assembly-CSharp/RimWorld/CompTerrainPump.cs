...
namespace RimWorld
{
	public abstract class CompTerrainPump : ThingComp
	{
		...
		{
			CompTerrainPump.<CompGetGizmosExtra>c__Iterator16B <CompGetGizmosExtra>c__Iterator16B = new CompTerrainPump.<CompGetGizmosExtra>c__Iterator16B();
			<CompGetGizmosExtra>c__Iterator16B.<>f__this = this;
			CompTerrainPump.<CompGetGizmosExtra>c__Iterator16B expr_0E = <CompGetGizmosExtra>c__Iterator16B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
