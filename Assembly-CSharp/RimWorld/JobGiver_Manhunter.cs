...
namespace RimWorld
{
	public class JobGiver_Manhunter : ThinkNode_JobGiver
	{
		...
		{
			return (Pawn)AttackTargetFinder.BestAttackTarget(pawn, TargetScanFlags.NeedThreat, (Thing x) => x is Pawn && x.def.race.intelligence >= Intelligence.ToolUser, 0f, 9999f, default(IntVec3), float.MaxValue, true, true);
		}
		...
		{
			return x is Pawn && x.def.race.intelligence >= Intelligence.ToolUser;
		}

		[CompilerGenerated]
		private static bool <FindTurretTarget>m__1(Thing t)
		{
