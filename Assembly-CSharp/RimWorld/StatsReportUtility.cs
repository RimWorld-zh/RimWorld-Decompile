...
namespace RimWorld
{
	public static class StatsReportUtility
	{
		...
		{
			StatsReportUtility.<StatsToDraw>c__Iterator194 <StatsToDraw>c__Iterator = new StatsReportUtility.<StatsToDraw>c__Iterator194();
			<StatsToDraw>c__Iterator.def = def;
			<StatsToDraw>c__Iterator.stuff = stuff;
			<StatsToDraw>c__Iterator.<$>def = def;
			<StatsToDraw>c__Iterator.<$>stuff = stuff;
			StatsReportUtility.<StatsToDraw>c__Iterator194 expr_23 = <StatsToDraw>c__Iterator;
			expr_23.$PC = -2;
			return expr_23;
		}
		...
		private static IEnumerable<StatDrawEntry> StatsToDraw(Thing thing)
		{
			...
			<StatsToDraw>c__Iterator.<$>thing = thing;
			StatsReportUtility.<StatsToDraw>c__Iterator195 expr_15 = <StatsToDraw>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
