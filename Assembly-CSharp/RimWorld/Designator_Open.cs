...
namespace RimWorld
{
	public class Designator_Open : Designator
	{
		...
		{
			Designator_Open.<OpenablesInCell>c__Iterator18C <OpenablesInCell>c__Iterator18C = new Designator_Open.<OpenablesInCell>c__Iterator18C();
			<OpenablesInCell>c__Iterator18C.c = c;
			<OpenablesInCell>c__Iterator18C.<$>c = c;
			<OpenablesInCell>c__Iterator18C.<>f__this = this;
			Designator_Open.<OpenablesInCell>c__Iterator18C expr_1C = <OpenablesInCell>c__Iterator18C;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
