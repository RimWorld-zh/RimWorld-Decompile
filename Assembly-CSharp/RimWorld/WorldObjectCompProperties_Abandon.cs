...
namespace RimWorld
{
	public class WorldObjectCompProperties_Abandon : WorldObjectCompProperties
	{
		...
		private sealed class <ConfigErrors>c__Iterator0 : IEnumerable, IEnumerable<string>, IEnumerator, IDisposable, IEnumerator<string>
		{
			...
			internal WorldObjectCompProperties_Abandon $this;
			...
			IEnumerator<string> IEnumerable<string>.GetEnumerator()
			{
				...
				WorldObjectCompProperties_Abandon.<ConfigErrors>c__Iterator0 <ConfigErrors>c__Iterator = new WorldObjectCompProperties_Abandon.<ConfigErrors>c__Iterator0();
