...
namespace RimWorld
{
	public class Alert_LifeThreateningHediff : Alert_Critical
	{
		private IEnumerable<Pawn> SickPawns
		{
			get
			{
				Alert_LifeThreateningHediff.<>c__Iterator185 <>c__Iterator = new Alert_LifeThreateningHediff.<>c__Iterator185();
				Alert_LifeThreateningHediff.<>c__Iterator185 expr_07 = <>c__Iterator;
				expr_07.$PC = -2;
				return expr_07;
			}
		}
