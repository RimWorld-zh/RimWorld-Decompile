...
namespace RimWorld
{
	public sealed class MemoryThoughtHandler : IExposable
	{
		...
		[CompilerGenerated]
		private sealed class <RemoveMemoriesOfDefWhereOtherPawnIs>c__AnonStorey0
		{
			internal ThoughtDef def;

			internal Pawn otherPawn;

			public <RemoveMemoriesOfDefWhereOtherPawnIs>c__AnonStorey0()
			{
			}

			internal bool <>m__0(Thought_Memory x)
			{
		...
		[CompilerGenerated]
		private sealed class <RemoveMemoriesWhereOtherPawnIs>c__AnonStorey1
		{
			internal Pawn otherPawn;

			public <RemoveMemoriesWhereOtherPawnIs>c__AnonStorey1()
			{
			}
		...
		[CompilerGenerated]
		private sealed class <RemoveMemoriesOfDef>c__AnonStorey2
		{
			internal ThoughtDef def;

			public <RemoveMemoriesOfDef>c__AnonStorey2()
			{
			}
		...
		[CompilerGenerated]
		private sealed class <RemoveMemoriesOfDefIf>c__AnonStorey3
		{
			internal ThoughtDef def;

			internal Func<Thought_Memory, bool> predicate;

			public <RemoveMemoriesOfDefIf>c__AnonStorey3()
			{
			}

			internal bool <>m__0(Thought_Memory x)
			{
				return x.def == this.def && this.predicate(x);
			}
		}
	}
}
