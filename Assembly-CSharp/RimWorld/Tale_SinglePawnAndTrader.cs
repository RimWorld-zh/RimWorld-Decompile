...
namespace RimWorld
{
	public class Tale_SinglePawnAndTrader : Tale_SinglePawn
	{
		...
		{
			Tale_SinglePawnAndTrader.<SpecialTextGenerationRules>c__Iterator136 <SpecialTextGenerationRules>c__Iterator = new Tale_SinglePawnAndTrader.<SpecialTextGenerationRules>c__Iterator136();
			<SpecialTextGenerationRules>c__Iterator.<>f__this = this;
			Tale_SinglePawnAndTrader.<SpecialTextGenerationRules>c__Iterator136 expr_0E = <SpecialTextGenerationRules>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
