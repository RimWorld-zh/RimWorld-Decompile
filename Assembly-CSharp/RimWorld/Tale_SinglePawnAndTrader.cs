...
namespace RimWorld
{
	public class Tale_SinglePawnAndTrader : Tale_SinglePawn
	{
		...
		private sealed class <SpecialTextGenerationRules>c__Iterator0 : IEnumerable, IEnumerable<Rule>, IEnumerator, IDisposable, IEnumerator<Rule>
		{
			...
			internal Tale_SinglePawnAndTrader $this;
			...
			IEnumerator<Rule> IEnumerable<Rule>.GetEnumerator()
			{
				...
				Tale_SinglePawnAndTrader.<SpecialTextGenerationRules>c__Iterator0 <SpecialTextGenerationRules>c__Iterator = new Tale_SinglePawnAndTrader.<SpecialTextGenerationRules>c__Iterator0();
