...
namespace RimWorld
{
	...
	public class ColonistBarColonistDrawer
	{
		...
		public ColonistBarColonistDrawer()
		{
		}
		...
		[CompilerGenerated]
		private sealed class <DrawGroupFrame>c__AnonStorey0
		{
			internal int group;

			public <DrawGroupFrame>c__AnonStorey0()
			{
			}
		...
		[CompilerGenerated]
		private sealed class <HandleGroupFrameClicks>c__AnonStorey1
		{
			internal int group;

			public <HandleGroupFrameClicks>c__AnonStorey1()
			{
			}
