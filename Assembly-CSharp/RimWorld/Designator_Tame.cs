...
namespace RimWorld
{
	public class Designator_Tame : Designator
	{
		...
		{
			Designator_Tame.<TameablesInCell>c__Iterator190 <TameablesInCell>c__Iterator = new Designator_Tame.<TameablesInCell>c__Iterator190();
			<TameablesInCell>c__Iterator.c = c;
			<TameablesInCell>c__Iterator.<$>c = c;
			<TameablesInCell>c__Iterator.<>f__this = this;
			Designator_Tame.<TameablesInCell>c__Iterator190 expr_1C = <TameablesInCell>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
	}
