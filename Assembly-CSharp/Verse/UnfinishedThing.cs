...
namespace Verse
{
	public class UnfinishedThing : ThingWithComps
	{
		...
		{
			UnfinishedThing.<GetGizmos>c__Iterator228 <GetGizmos>c__Iterator = new UnfinishedThing.<GetGizmos>c__Iterator228();
			<GetGizmos>c__Iterator.<>f__this = this;
			UnfinishedThing.<GetGizmos>c__Iterator228 expr_0E = <GetGizmos>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
