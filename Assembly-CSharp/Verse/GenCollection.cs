...
namespace Verse
{
	public static class GenCollection
	{
		...
		{
			GenCollection.<InRandomOrder>c__Iterator246<T> <InRandomOrder>c__Iterator = new GenCollection.<InRandomOrder>c__Iterator246<T>();
			<InRandomOrder>c__Iterator.source = source;
			<InRandomOrder>c__Iterator.workingList = workingList;
			<InRandomOrder>c__Iterator.<$>source = source;
			<InRandomOrder>c__Iterator.<$>workingList = workingList;
			GenCollection.<InRandomOrder>c__Iterator246<T> expr_23 = <InRandomOrder>c__Iterator;
			expr_23.$PC = -2;
			return expr_23;
		}
