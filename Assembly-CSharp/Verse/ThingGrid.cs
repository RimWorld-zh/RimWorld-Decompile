...
namespace Verse
{
	public sealed class ThingGrid
	{
		...
		{
			ThingGrid.<ThingsAt>c__Iterator1F3 <ThingsAt>c__Iterator1F = new ThingGrid.<ThingsAt>c__Iterator1F3();
			<ThingsAt>c__Iterator1F.c = c;
			<ThingsAt>c__Iterator1F.<$>c = c;
			<ThingsAt>c__Iterator1F.<>f__this = this;
			ThingGrid.<ThingsAt>c__Iterator1F3 expr_1C = <ThingsAt>c__Iterator1F;
			expr_1C.$PC = -2;
			return expr_1C;
		}
