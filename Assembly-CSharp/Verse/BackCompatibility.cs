...
namespace Verse
{
	public static class BackCompatibility
	{
		...
		[CompilerGenerated]
		private sealed class <PawnTrainingTrackerPostLoadInit>c__AnonStorey0
		{
			internal Pawn_TrainingTracker tracker;

			public <PawnTrainingTrackerPostLoadInit>c__AnonStorey0()
			{
			}

			internal bool <>m__0(TrainableDef td)
			{
				return this.tracker.GetSteps(td) != 0;
			}
		}
	}
}
