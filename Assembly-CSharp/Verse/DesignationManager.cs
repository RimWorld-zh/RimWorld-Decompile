...
namespace Verse
{
	public sealed class DesignationManager : IExposable
	{
		...
		{
			DesignationManager.<AllDesignationsOn>c__Iterator1EF <AllDesignationsOn>c__Iterator1EF = new DesignationManager.<AllDesignationsOn>c__Iterator1EF();
			<AllDesignationsOn>c__Iterator1EF.t = t;
			<AllDesignationsOn>c__Iterator1EF.<$>t = t;
			<AllDesignationsOn>c__Iterator1EF.<>f__this = this;
			DesignationManager.<AllDesignationsOn>c__Iterator1EF expr_1C = <AllDesignationsOn>c__Iterator1EF;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		{
			DesignationManager.<AllDesignationsAt>c__Iterator1F0 <AllDesignationsAt>c__Iterator1F = new DesignationManager.<AllDesignationsAt>c__Iterator1F0();
			<AllDesignationsAt>c__Iterator1F.c = c;
			<AllDesignationsAt>c__Iterator1F.<$>c = c;
			<AllDesignationsAt>c__Iterator1F.<>f__this = this;
			DesignationManager.<AllDesignationsAt>c__Iterator1F0 expr_1C = <AllDesignationsAt>c__Iterator1F;
			expr_1C.$PC = -2;
			return expr_1C;
		}
