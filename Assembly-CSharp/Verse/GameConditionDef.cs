...
namespace Verse
{
	public class GameConditionDef : Def
	{
		...
		{
			GameConditionDef.<ConfigErrors>c__Iterator1C6 <ConfigErrors>c__Iterator1C = new GameConditionDef.<ConfigErrors>c__Iterator1C6();
			<ConfigErrors>c__Iterator1C.<>f__this = this;
			GameConditionDef.<ConfigErrors>c__Iterator1C6 expr_0E = <ConfigErrors>c__Iterator1C;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
