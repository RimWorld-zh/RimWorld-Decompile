...
namespace Verse
{
	public class VerbTracker : IExposable
	{
		...
		{
			VerbTracker.<GetVerbsCommands>c__Iterator256 <GetVerbsCommands>c__Iterator = new VerbTracker.<GetVerbsCommands>c__Iterator256();
			<GetVerbsCommands>c__Iterator.<>f__this = this;
			VerbTracker.<GetVerbsCommands>c__Iterator256 expr_0E = <GetVerbsCommands>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
