...
namespace Verse
{
	public class PawnInventoryOption
	{
		...
		{
			PawnInventoryOption.<GenerateThings>c__Iterator1D2 <GenerateThings>c__Iterator1D = new PawnInventoryOption.<GenerateThings>c__Iterator1D2();
			<GenerateThings>c__Iterator1D.<>f__this = this;
			PawnInventoryOption.<GenerateThings>c__Iterator1D2 expr_0E = <GenerateThings>c__Iterator1D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
