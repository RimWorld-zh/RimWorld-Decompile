...
namespace Verse
{
	...
	{
		private const float BackLiftAmount = 0.00241935486f;

		private const float TwistAmount = 0.00120967743f;
		...
		public static Mesh NewPlaneMesh(Vector2 size, bool flipped, bool backLift, bool twist)
		{
			...
			if (backLift)
			{
				array[1].y = 0.00241935486f;
				array[2].y = 0.00241935486f;
				array[3].y = 0.000967741944f;
			}
			if (twist)
			{
				array[0].y = 0.00120967743f;
				array[1].y = 0.0006048387f;
				array[2].y = 0f;
				array[3].y = 0.0006048387f;
			}
			if (!flipped)
			{
