...
namespace Verse
{
	public class PriorityWork : IExposable
	{
		...
		{
			PriorityWork.<GetGizmos>c__Iterator1B8 <GetGizmos>c__Iterator1B = new PriorityWork.<GetGizmos>c__Iterator1B8();
			<GetGizmos>c__Iterator1B.<>f__this = this;
			PriorityWork.<GetGizmos>c__Iterator1B8 expr_0E = <GetGizmos>c__Iterator1B;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
