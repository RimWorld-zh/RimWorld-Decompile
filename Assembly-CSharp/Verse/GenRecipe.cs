...
namespace Verse
{
	public static class GenRecipe
	{
		...
		{
			GenRecipe.<MakeRecipeProducts>c__Iterator244 <MakeRecipeProducts>c__Iterator = new GenRecipe.<MakeRecipeProducts>c__Iterator244();
			...
			<MakeRecipeProducts>c__Iterator.<$>dominantIngredient = dominantIngredient;
			<MakeRecipeProducts>c__Iterator.<$>ingredients = ingredients;
			GenRecipe.<MakeRecipeProducts>c__Iterator244 expr_3F = <MakeRecipeProducts>c__Iterator;
			expr_3F.$PC = -2;
			return expr_3F;
		}
