...
namespace Verse
{
	public sealed class ListerBuildings
	{
		...
		{
			ListerBuildings.<AllBuildingsColonistOfDef>c__Iterator1F6 <AllBuildingsColonistOfDef>c__Iterator1F = new ListerBuildings.<AllBuildingsColonistOfDef>c__Iterator1F6();
			<AllBuildingsColonistOfDef>c__Iterator1F.def = def;
			<AllBuildingsColonistOfDef>c__Iterator1F.<$>def = def;
			<AllBuildingsColonistOfDef>c__Iterator1F.<>f__this = this;
			ListerBuildings.<AllBuildingsColonistOfDef>c__Iterator1F6 expr_1C = <AllBuildingsColonistOfDef>c__Iterator1F;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		{
			ListerBuildings.<AllBuildingsColonistOfClass>c__Iterator1F7<T> <AllBuildingsColonistOfClass>c__Iterator1F = new ListerBuildings.<AllBuildingsColonistOfClass>c__Iterator1F7<T>();
			<AllBuildingsColonistOfClass>c__Iterator1F.<>f__this = this;
			ListerBuildings.<AllBuildingsColonistOfClass>c__Iterator1F7<T> expr_0E = <AllBuildingsColonistOfClass>c__Iterator1F;
			expr_0E.$PC = -2;
			return expr_0E;
		}
	}
