...
namespace Verse
{
	public class RulePackDef : Def
	{
		...
		{
			RulePackDef.<ConfigErrors>c__Iterator1D2 <ConfigErrors>c__Iterator1D = new RulePackDef.<ConfigErrors>c__Iterator1D2();
			<ConfigErrors>c__Iterator1D.<>f__this = this;
			RulePackDef.<ConfigErrors>c__Iterator1D2 expr_0E = <ConfigErrors>c__Iterator1D;
			expr_0E.$PC = -2;
			return expr_0E;
		}
