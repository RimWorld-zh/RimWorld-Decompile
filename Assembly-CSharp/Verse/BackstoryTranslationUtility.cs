...
namespace Verse
{
	public static class BackstoryTranslationUtility
	{
		...
		{
			BackstoryTranslationUtility.<BackstoryTranslationElements>c__Iterator1E5 <BackstoryTranslationElements>c__Iterator1E = new BackstoryTranslationUtility.<BackstoryTranslationElements>c__Iterator1E5();
			<BackstoryTranslationElements>c__Iterator1E.lang = lang;
			<BackstoryTranslationElements>c__Iterator1E.<$>lang = lang;
			BackstoryTranslationUtility.<BackstoryTranslationElements>c__Iterator1E5 expr_15 = <BackstoryTranslationElements>c__Iterator1E;
			expr_15.$PC = -2;
			return expr_15;
		}
		...
		{
			BackstoryTranslationUtility.<MissingBackstoryTranslations>c__Iterator1E6 <MissingBackstoryTranslations>c__Iterator1E = new BackstoryTranslationUtility.<MissingBackstoryTranslations>c__Iterator1E6();
			<MissingBackstoryTranslations>c__Iterator1E.lang = lang;
			<MissingBackstoryTranslations>c__Iterator1E.<$>lang = lang;
			BackstoryTranslationUtility.<MissingBackstoryTranslations>c__Iterator1E6 expr_15 = <MissingBackstoryTranslations>c__Iterator1E;
			expr_15.$PC = -2;
			return expr_15;
		}
	}
