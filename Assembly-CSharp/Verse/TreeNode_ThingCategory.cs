...
namespace Verse
{
	public class TreeNode_ThingCategory : TreeNode
	{
		...
		public IEnumerable<TreeNode_ThingCategory> ChildCategoryNodesAndThis
		{
			get
			{
				TreeNode_ThingCategory.<>c__Iterator22C <>c__Iterator22C = new TreeNode_ThingCategory.<>c__Iterator22C();
				<>c__Iterator22C.<>f__this = this;
				TreeNode_ThingCategory.<>c__Iterator22C expr_0E = <>c__Iterator22C;
				expr_0E.$PC = -2;
				return expr_0E;
			}
		}
