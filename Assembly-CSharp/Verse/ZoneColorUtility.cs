...
namespace Verse
{
	public static class ZoneColorUtility
	{
		...
		{
			ZoneColorUtility.<GrowingZoneColors>c__Iterator204 <GrowingZoneColors>c__Iterator = new ZoneColorUtility.<GrowingZoneColors>c__Iterator204();
			ZoneColorUtility.<GrowingZoneColors>c__Iterator204 expr_07 = <GrowingZoneColors>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
		...
		{
			ZoneColorUtility.<StorageZoneColors>c__Iterator205 <StorageZoneColors>c__Iterator = new ZoneColorUtility.<StorageZoneColors>c__Iterator205();
			ZoneColorUtility.<StorageZoneColors>c__Iterator205 expr_07 = <StorageZoneColors>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
	}
