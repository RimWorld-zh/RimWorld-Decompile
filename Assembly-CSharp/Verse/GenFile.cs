...
namespace Verse
{
	public static class GenFile
	{
		...
		{
			GenFile.<LinesFromFile>c__Iterator240 <LinesFromFile>c__Iterator = new GenFile.<LinesFromFile>c__Iterator240();
			<LinesFromFile>c__Iterator.filePath = filePath;
			<LinesFromFile>c__Iterator.<$>filePath = filePath;
			GenFile.<LinesFromFile>c__Iterator240 expr_15 = <LinesFromFile>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
