...
namespace Verse
{
	internal static class EnvironmentInspectDrawer
	{
		...
		{
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF <DrawInfoWindow>c__AnonStorey5CF = new EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF();
			<DrawInfoWindow>c__AnonStorey5CF.room = UI.MouseCell().GetRoom(Find.VisibleMap, RegionType.Set_All);
			<DrawInfoWindow>c__AnonStorey5CF.roomValid = (<DrawInfoWindow>c__AnonStorey5CF.room != null && <DrawInfoWindow>c__AnonStorey5CF.room.Role != RoomRoleDefOf.None);
			Text.Font = GameFont.Small;
			<DrawInfoWindow>c__AnonStorey5CF.windowRect = new Rect(Event.current.mousePosition.x, Event.current.mousePosition.y, 416f, 36f);
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF expr_8A_cp_0 = <DrawInfoWindow>c__AnonStorey5CF;
			expr_8A_cp_0.windowRect.height = expr_8A_cp_0.windowRect.height + 25f;
			if (<DrawInfoWindow>c__AnonStorey5CF.roomValid)
			{
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF expr_AC_cp_0 = <DrawInfoWindow>c__AnonStorey5CF;
				expr_AC_cp_0.windowRect.height = expr_AC_cp_0.windowRect.height + 13f;
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF expr_C3_cp_0 = <DrawInfoWindow>c__AnonStorey5CF;
				expr_C3_cp_0.windowRect.height = expr_C3_cp_0.windowRect.height + 23f;
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF expr_DA_cp_0 = <DrawInfoWindow>c__AnonStorey5CF;
				expr_DA_cp_0.windowRect.height = expr_DA_cp_0.windowRect.height + (float)EnvironmentInspectDrawer.DisplayedRoomStatsCount * 25f;
			}
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF expr_F8_cp_0 = <DrawInfoWindow>c__AnonStorey5CF;
			expr_F8_cp_0.windowRect.x = expr_F8_cp_0.windowRect.x + 26f;
			EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF expr_10F_cp_0 = <DrawInfoWindow>c__AnonStorey5CF;
			expr_10F_cp_0.windowRect.y = expr_10F_cp_0.windowRect.y + 26f;
			if (<DrawInfoWindow>c__AnonStorey5CF.windowRect.xMax > (float)UI.screenWidth)
			{
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF expr_13C_cp_0 = <DrawInfoWindow>c__AnonStorey5CF;
				expr_13C_cp_0.windowRect.x = expr_13C_cp_0.windowRect.x - (<DrawInfoWindow>c__AnonStorey5CF.windowRect.width + 52f);
			}
			if (<DrawInfoWindow>c__AnonStorey5CF.windowRect.yMax > (float)UI.screenHeight)
			{
				EnvironmentInspectDrawer.<DrawInfoWindow>c__AnonStorey5CF expr_175_cp_0 = <DrawInfoWindow>c__AnonStorey5CF;
				expr_175_cp_0.windowRect.y = expr_175_cp_0.windowRect.y - (<DrawInfoWindow>c__AnonStorey5CF.windowRect.height + 52f);
			}
			Find.WindowStack.ImmediateWindow(74975, <DrawInfoWindow>c__AnonStorey5CF.windowRect, WindowLayer.Super, delegate
			{
				...
				Rect rect = new Rect(18f, num, <DrawInfoWindow>c__AnonStorey5CF.windowRect.width - 36f, 100f);
				...
				if (<DrawInfoWindow>c__AnonStorey5CF.roomValid)
				{
					...
					Widgets.DrawLineHorizontal(18f, num, <DrawInfoWindow>c__AnonStorey5CF.windowRect.width - 36f);
					GUI.color = Color.white;
					num += 8f;
					Rect rect2 = new Rect(18f, num, <DrawInfoWindow>c__AnonStorey5CF.windowRect.width - 36f, 100f);
					GUI.color = Color.white;
					Widgets.Label(rect2, EnvironmentInspectDrawer.GetRoomRoleLabel(<DrawInfoWindow>c__AnonStorey5CF.room));
					num += 25f;
					Text.WordWrap = false;
					for (int i = 0; i < DefDatabase<RoomStatDef>.AllDefsListForReading.Count; i++)
					{
						...
						{
							float stat = <DrawInfoWindow>c__AnonStorey5CF.room.GetStat(roomStatDef);
							RoomStatScoreStage scoreStage = roomStatDef.GetScoreStage(stat);
							if (<DrawInfoWindow>c__AnonStorey5CF.room.Role.IsStatRelated(roomStatDef))
							{
