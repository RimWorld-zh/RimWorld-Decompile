...
namespace Verse
{
	public class Pawn_InventoryTracker : IThingHolder, IExposable
	{
		...
		static Pawn_InventoryTracker()
		{
		}

		[CompilerGenerated]
		private sealed class <DropAllNearPawn>c__AnonStorey0
		{
			internal bool forbid;

			internal bool unforbid;

			public <DropAllNearPawn>c__AnonStorey0()
			{
			}
