...
namespace Verse.AI
{
	public abstract class MentalState_TantrumRandom : MentalState_Tantrum
	{
		...
		protected MentalState_TantrumRandom()
		{
		}
		...
		static MentalState_TantrumRandom()
		{
		}

		[CompilerGenerated]
		private bool <ChooseNextTarget>m__0(Thing x)
		{
			return x != this.target;
		}

		[CompilerGenerated]
		private bool <ChooseNextTarget>m__1(Thing x)
		{
			return x != this.target;
		}

		[CompilerGenerated]
		private float <ChooseNextTarget>m__2(Thing x)
		{
			return this.GetCandidateWeight(x);
		}

		[CompilerGenerated]
		private float <ChooseNextTarget>m__3(Thing x)
		{
			return this.GetCandidateWeight(x);
		}
	}
