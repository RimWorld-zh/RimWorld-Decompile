...
namespace Verse.AI
{
	...
	public abstract class JobDriver : IExposable, IJobEndable
	{
		...
		// (get) Token: 0x06003A54 RID: 14932 RVA: 0x00010F0C File Offset: 0x0000F30C
		...
		// (get) Token: 0x06003A55 RID: 14933 RVA: 0x00010FE4 File Offset: 0x0000F3E4
		...
		// (get) Token: 0x06003A56 RID: 14934 RVA: 0x0001101C File Offset: 0x0000F41C
		...
		// (get) Token: 0x06003A57 RID: 14935 RVA: 0x00011064 File Offset: 0x0000F464
		...
		// (get) Token: 0x06003A58 RID: 14936 RVA: 0x00011080 File Offset: 0x0000F480
		...
		// (get) Token: 0x06003A59 RID: 14937 RVA: 0x000110AC File Offset: 0x0000F4AC
		...
		// (get) Token: 0x06003A5A RID: 14938 RVA: 0x000110F4 File Offset: 0x0000F4F4
		...
		// (get) Token: 0x06003A5B RID: 14939 RVA: 0x00011124 File Offset: 0x0000F524
		...
		// (get) Token: 0x06003A5C RID: 14940 RVA: 0x00011144 File Offset: 0x0000F544
		...
		// (get) Token: 0x06003A5D RID: 14941 RVA: 0x00011164 File Offset: 0x0000F564
		...
		// (get) Token: 0x06003A5E RID: 14942 RVA: 0x00011184 File Offset: 0x0000F584
		// (set) Token: 0x06003A5F RID: 14943 RVA: 0x000111A9 File Offset: 0x0000F5A9
		...
		// (get) Token: 0x06003A60 RID: 14944 RVA: 0x000111C0 File Offset: 0x0000F5C0
		// (set) Token: 0x06003A61 RID: 14945 RVA: 0x000111E5 File Offset: 0x0000F5E5
		...
		// (get) Token: 0x06003A62 RID: 14946 RVA: 0x000111FC File Offset: 0x0000F5FC
		...
		// (get) Token: 0x06003A63 RID: 14947 RVA: 0x00011224 File Offset: 0x0000F624
		protected Map Map
		{
			get
			{
		...
		// Token: 0x06003A64 RID: 14948 RVA: 0x00011244 File Offset: 0x0000F644
		public virtual string GetReport()
		{
			return this.ReportStringProcessed(this.job.def.reportString);
		}

		// Token: 0x06003A65 RID: 14949 RVA: 0x00011270 File Offset: 0x0000F670
		...
		// Token: 0x06003A68 RID: 14952 RVA: 0x0001144B File Offset: 0x0000F84B
		public virtual void SetInitialPosture()
		{
			this.pawn.jobs.posture = PawnPosture.Standing;
		}

		// Token: 0x06003A69 RID: 14953 RVA: 0x00011460 File Offset: 0x0000F860
		...
		// Token: 0x06003A6A RID: 14954 RVA: 0x0001155C File Offset: 0x0000F95C
		...
		// Token: 0x06003A6B RID: 14955 RVA: 0x00011644 File Offset: 0x0000FA44
		public virtual bool CanBeginNowWhileLyingDown()
		{
			return false;
		}

		// Token: 0x06003A6C RID: 14956 RVA: 0x0001165C File Offset: 0x0000FA5C
		...
		// Token: 0x06003A6D RID: 14957 RVA: 0x00011734 File Offset: 0x0000FB34
		...
		// Token: 0x06003A6E RID: 14958 RVA: 0x00011978 File Offset: 0x0000FD78
		...
		// Token: 0x06003A6F RID: 14959 RVA: 0x00011988 File Offset: 0x0000FD88
		...
		// Token: 0x06003A70 RID: 14960 RVA: 0x00011C28 File Offset: 0x00010028
		...
		// Token: 0x06003A71 RID: 14961 RVA: 0x00011C64 File Offset: 0x00010064
		...
		// Token: 0x06003A72 RID: 14962 RVA: 0x00011C88 File Offset: 0x00010088
		...
		// Token: 0x06003A73 RID: 14963 RVA: 0x00011E94 File Offset: 0x00010294
		...
		// Token: 0x06003A74 RID: 14964 RVA: 0x00011F20 File Offset: 0x00010320
		...
		// Token: 0x06003A75 RID: 14965 RVA: 0x00011F73 File Offset: 0x00010373
		public virtual void Notify_Starting()
		{
			this.startTick = Find.TickManager.TicksGame;
		}

		// Token: 0x06003A76 RID: 14966 RVA: 0x00011F86 File Offset: 0x00010386
		...
		// Token: 0x06003A77 RID: 14967 RVA: 0x00011F9B File Offset: 0x0001039B
		public virtual void Notify_PatherFailed()
		{
			this.EndJobWith(JobCondition.ErroredPather);
		}

		// Token: 0x06003A78 RID: 14968 RVA: 0x00011FA5 File Offset: 0x000103A5
		public virtual void Notify_StanceChanged()
		{
		}

		// Token: 0x06003A79 RID: 14969 RVA: 0x00011FA8 File Offset: 0x000103A8
		public virtual void Notify_DamageTaken(DamageInfo dinfo)
		{
		}

		// Token: 0x06003A7A RID: 14970 RVA: 0x00011FAC File Offset: 0x000103AC
		public Pawn GetActor()
		{
			return this.pawn;
		}

		// Token: 0x06003A7B RID: 14971 RVA: 0x00011FC7 File Offset: 0x000103C7
		public void AddEndCondition(Func<JobCondition> newEndCondition)
		{
			this.globalFailConditions.Add(newEndCondition);
		}

		// Token: 0x06003A7C RID: 14972 RVA: 0x00011FD8 File Offset: 0x000103D8
		...
		// Token: 0x06003A7D RID: 14973 RVA: 0x0001200A File Offset: 0x0001040A
		public void AddFinishAction(Action newAct)
		{
			this.globalFinishActions.Add(newAct);
		}

		// Token: 0x06003A7E RID: 14974 RVA: 0x0001201C File Offset: 0x0001041C
		public virtual bool ModifyCarriedThingDrawPos(ref Vector3 drawPos, ref bool behind, ref bool flip)
		{
			return false;
		}

		// Token: 0x06003A7F RID: 14975 RVA: 0x00012034 File Offset: 0x00010434
		...
		// Token: 0x06003A80 RID: 14976 RVA: 0x00012068 File Offset: 0x00010468
