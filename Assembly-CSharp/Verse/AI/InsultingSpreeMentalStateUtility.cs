...
namespace Verse.AI
{
	public static class InsultingSpreeMentalStateUtility
	{
		...
		[CompilerGenerated]
		private sealed class <GetInsultCandidatesFor>c__AnonStorey0
		{
			internal TraverseParms traverseParams;

			internal Pawn bully;

			internal bool allowPrisoners;

			internal List<Pawn> outCandidates;

			public <GetInsultCandidatesFor>c__AnonStorey0()
			{
			}
