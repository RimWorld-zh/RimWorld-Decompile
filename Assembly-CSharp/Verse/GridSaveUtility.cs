...
namespace Verse
{
	public static class GridSaveUtility
	{
		...
		{
			GridSaveUtility.<LoadedUShortGrid>c__Iterator203 <LoadedUShortGrid>c__Iterator = new GridSaveUtility.<LoadedUShortGrid>c__Iterator203();
			<LoadedUShortGrid>c__Iterator.compressedString = compressedString;
			<LoadedUShortGrid>c__Iterator.map = map;
			<LoadedUShortGrid>c__Iterator.<$>compressedString = compressedString;
			<LoadedUShortGrid>c__Iterator.<$>map = map;
			GridSaveUtility.<LoadedUShortGrid>c__Iterator203 expr_23 = <LoadedUShortGrid>c__Iterator;
			expr_23.$PC = -2;
			return expr_23;
		}
	}
