...
namespace Verse.Steam
{
	public static class Workshop
	{
		...
		{
			Workshop.<AllSubscribedItems>c__Iterator254 <AllSubscribedItems>c__Iterator = new Workshop.<AllSubscribedItems>c__Iterator254();
			Workshop.<AllSubscribedItems>c__Iterator254 expr_07 = <AllSubscribedItems>c__Iterator;
			expr_07.$PC = -2;
			return expr_07;
		}
